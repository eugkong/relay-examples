...
The application will now be running at [`localhost:3003`](http://localhost:3003). This application also has [GraphiQL](https://github.com/graphql/graphiql) setup so that you can run test queries against the schema. Navigate to [`localhost:3003/playground`](http://localhost:3003) to try it out.
